...
This package composes tailored cold-outreach emails from normalized job-board rows and stages them
as Gmail **drafts** in the user's mailbox. It is draft-only
