...
The user's faculty archive from his Las Vegas teaching job (2021-22 era), copied 2026-06-07 from `/mnt/media/gmk-server-share/Business/Teaching English/` (Mac cruft stripped; non-teaching items like Taxes/ and business decks preserved as found — owner will sort). 2.1 GB, 1,163 files: final exams + answer keys by textbook (Interchange 2/3, Passages 1/2, Grammar and Beyond 1-4, Let's Talk, Real Talk, Ventures, Clear Speech, Final Draft, more), the full textbook listening audio (714 mp3/wma), syllabi, the student handbook. 2026-06-08: added the complete Interchange 5th-edition book sets (Intro/1/2/3 — Student Book, Teacher Book, Workbook, Video Resource Book; 16 PDFs, ~1.3GB) pulled from the owner Mac Downloads, consolidated under BOOKS/ (organized by series). 2026-06-08: also added Passages 3rd-ed SBs+WB, Grammar & Beyond Essentials 1-4, Clear Speech 4th-ed SB, Parrott (teacher grammar reference), Let's Talk 1, Present Yourself 1-2 — see books-to-acquire.md for the full have/to-get list. Gitignored.
