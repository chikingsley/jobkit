"""Wave 1 unit registry — the corpus-covered units (docs/course-blueprint.md, status ✅).
...
# Verified citation facts, reused across units (from docs/curriculum-research.md §4 — never extend).
CF_FACTS = """\
...
# --- additional verified citation facts (docs/curriculum-research.md §4) ----------------------
...
_REF_HAMADA = (
    "Hamada, A. (2020). Using meta-analysis and propensity score methods to assess treatment "
    "effects toward evidence-based practice in extensive reading. *Frontiers in Psychology*, "
    "11, 617."
)
_REF_PASHLER = (
...
def _r(query: str, scope: str, **kw: Any) -> dict[str, Any]:  # noqa: ANN401 - dynamic Unit kwargs
...
_WAVE23: list[Unit] = [
    ...
    Unit(
        uid="1.1",
        title="The World of TEFL: Markets, Learners, and Contexts",
        module="M1 — The TEFL World",
        **_r(
            "teaching English abroad contexts learners young adult primary secondary classroom "
    ...
    Unit(
        uid="1.2",
        title="How People Learn Languages: First Language, Second Language, and Input",
        module="M1 — The TEFL World",
        **_r(
            "how learners acquire language input comprehension exposure first language second "
    ...
    Unit(
        uid="1.3",
        title="What Makes an Effective Teacher",
        module="M1 — The TEFL World",
        **_r(
            "effective teacher qualities classroom rapport preparation clarity caring "
    ...
    Unit(
        uid="1.4",
        title="Levels and Proficiency: From Beginner to Advanced",
        module="M1 — The TEFL World",
        mode="facts",
        scope=(
    ...
    Unit(
        uid="1.5",
        title="First Lessons: Setting the Stage and Breaking the Ice",
        module="M1 — The TEFL World",
        **_r(
            "first lesson icebreaker getting to know students names classroom routines warm-up "
    ...
    Unit(
        uid="2.1",
        title="Grammatical Terms and the Parts of Speech",
        module="M2 — English Grammar for Teachers I",
        mode="facts",
        scope=(
    ...
    Unit(
        uid="2.3",
        title="The Tense System: Time, Tense, and Aspect",
        module="M2 — English Grammar for Teachers I",
        mode="facts",
        scope=(
    ...
    Unit(
        uid="2.5",
        title="Common Learner Errors by First-Language Background",
        module="M2 — English Grammar for Teachers I",
        mode="facts",
        scope=(
    ...
    Unit(
        uid="3.6",
        title="Functional Language and Idiom",
        module="M3 — English Grammar for Teachers II",
        **_r(
            "functional language expressions requesting apologizing inviting suggesting "
    ...
    Unit(
        uid="4.1",
        title="The Communicative Approach and Its Rivals: A Short, Honest History",
        module="M4 — Teaching Methods",
        **_r(
            "communicative language teaching methods approaches grammar translation audiolingual "
            ...
            citation_facts=GREGG_FACT,
            references=(_REF_GREGG, _REF_COMPANION),
        ),
    ),
    Unit(
        uid="4.3",
        title="PPP and Test-Teach-Test",
        module="M4 — Teaching Methods",
        **_r(
            "presentation practice production lesson framework controlled freer practice "
    ...
    Unit(
        uid="4.4",
        title="Task-Based Language Teaching: What the Evidence Says",
        module="M4 — Teaching Methods",
        **_r(
            "task based learning meaningful tasks real outcomes communication problem solving "
            ...
            citation_facts=TBLT_FACTS,
            references=(_REF_BM, _REF_XUAN, _REF_COMPANION),
        ),
    ),
    # --- M5 Vocabulary ---
    Unit(
        uid="5.1",
        title="How Vocabulary Is Learned: Retrieval Beats Re-Reading",
        module="M5 — Vocabulary",
        **_r(
            "vocabulary learning words memory recall practice testing remembering new words "
            ...
            citation_facts=RETRIEVAL_FACTS,
            references=(_REF_KR, _REF_COMPANION),
        ),
    ),
    Unit(
        uid="5.2",
        title="Spacing and Review Schedules",
        module="M5 — Vocabulary",
        **_r(
            "spaced practice review schedule spacing repetition over time forgetting curve "
            ...
            citation_facts=SPACING_FACTS,
            references=(_REF_NAKATA, _REF_KW, _REF_COMPANION),
        ),
    ),
    Unit(
        uid="5.3",
        title="Teaching Techniques and Vocabulary Activities",
        module="M5 — Vocabulary",
        **_r(
            "vocabulary activities games presenting new words meaning context pictures word "
            ...
            references=(
                _SD_ACTIVITIES.format(t="*Activate: Games for Learning American English*"),
                _SD_ACTIVITIES.format(t="*Create to Communicate*"),
                _REF_COMPANION,
            ),
        ),
    ),
    ...
    Unit(
        uid="6.1",
        title="The Sounds of English: Phonological Awareness",
    ...
    Unit(
        ...
        module="M6 — Phonology and Pronunciation",
        **_r(
            "teaching pronunciation practice drilling minimal pairs sounds intelligibility "
    ...
    Unit(
        ...
        **_r(
            "teaching listening comprehension pre-listening while-listening tasks audio "
    ...
    Unit(
        uid="7.3",
        title="Extensive Reading: The Evidence",
        module="M7 — Receptive Skills",
        **_r(
            "extensive reading graded readers reading for pleasure amount of reading fluency "
            ...
            references=(_REF_NAKANISHI, _REF_JEON, _REF_HAMADA, _REF_COMPANION),
        ),
    ),
    ...
    Unit(
        ...
        **_r(
            "teaching speaking fluency accuracy communication activities role play discussion "
    ...
    Unit(
        uid="8.3",
        title="Teaching Writing I: From Sentence to Paragraph",
        module="M8 — Productive Skills",
        **_r(
            "teaching writing sentences paragraphs topic sentence structure controlled writing "
    ...
    Unit(
        uid="8.4",
        title="Teaching Writing II: Process Writing and Correction Codes",
        module="M8 — Productive Skills",
        **_r(
            "process writing drafting revising editing feedback on writing correction codes "
    ...
    Unit(
        ...
        **_r(
            "lesson aims objectives what students will be able to do learning outcomes clear "
    ...
    Unit(
        uid="10.2",
        title="Components of a Lesson Plan",
        module="M10 — Lesson Planning and Materials",
        **_r(
            "lesson plan stages timing materials anticipated problems procedure warm up "
    ...
    Unit(
        uid="10.3",
        title="Planning a Lesson, Start to Finish",
        module="M10 — Lesson Planning and Materials",
        **_r(
            "planning a lesson example worked plan choosing activities sequencing stages "
    ...
    Unit(
        uid="10.4",
        title="Coursebooks: Choosing, Using, and Adapting",
        module="M10 — Lesson Planning and Materials",
        mode="facts",
        scope=(
    ...
    Unit(
        uid="10.5",
        title="Supplementary and Self-Made Materials, Teaching Aids",
        module="M10 — Lesson Planning and Materials",
        **_r(
            "supplementary materials self-made teaching aids flashcards realia visuals "
    ...
    Unit(
        ...
        module="M10 — Lesson Planning and Materials",
        **_r(
            "teaching with limited resources no technology large classes few materials "
    ...
    Unit(
        ...
        **_r(
            "classroom behaviour discipline rules routines managing disruption attention "
    ...
    Unit(
        ...
        module="M11 — Classroom Management",
        **_r(
            "teacher roles controller facilitator monitor prompter resource organizer shifting "
    ...
    Unit(
        uid="11.4",
        title="Classroom Language and Giving Instructions",
        module="M11 — Classroom Management",
        **_r(
            "classroom language giving instructions clear simple checking understanding "
    ...
    Unit(
        uid="11.5",
        title="Culture and Its Implications",
        module="M11 — Classroom Management",
        **_r(
            "culture cross-cultural classroom expectations differences teaching abroad "
    ...
    Unit(
        uid="12.2",
        title="The Learning-Styles Myth (and What to Do Instead)",
    ...
    Unit(
        ...
        module="M12 — Knowing Your Learners",
        **_r(
            "motivation learners engagement interest intrinsic extrinsic keeping students "
    ...
    Unit(
        ...
        **_r(
            "assessment tasks testing what to assess validity matching test to objectives "
    ...
    Unit(
        uid="13.3",
        title="Writing Good Tests (and Why Testing Teaches)",
        module="M13 — Assessment and Testing",
        **_r(
            "writing test items multiple choice gap fill clear instructions fair tests "
    ...
    Unit(
        uid="14.2",
        title="Business English and One-to-One Teaching",
        module="M14 — Specializations and the Working Teacher",
        mode="facts",
        scope=(
