...
**1. According to the unit, what is the most significant consequence of large class size for language learning?**
   ...
   c. Shared time sharply limits each learner's language production
   d. Teachers lose the ability to use pair work because rooms are too crowded to rearrange

   *Answer: c. Shared time sharply limits each learner's language production*
...
**2. The unit explains that displaying group work products on the classroom wall serves a purpose beyond the lesson itself. What does the unit identify as a key benefit of this practice?**
   ...
   *Answer: d. It creates a circulation of attention among students who read and respond to each other's work*
...
**3. The unit describes a specific risk when a teacher circulates without a plan during student work time. What is that risk?**
   ...
   a. Unplanned circulation favors confident, front-row students
   b. Students in the front rows will feel singled out and become reluctant to participate
   c. The teacher will spend too long at each desk and fail to complete the lesson
   d. Pair work will break down because students expect the teacher to visit every pair equally

   *Answer: a. Unplanned circulation favors confident, front-row students*
...
**4. According to the unit, why is a punitive response to off-task behavior considered insufficient as a management tool?**
   ...
   b. It stops behavior without teaching an alternative
   ...
   *Answer: b. It stops behavior without teaching an alternative*
...
**5. The unit argues that content-based instruction contributes to behavior management. What specific reason is given for this claim?**
   ...
   b. It replaces the need for learning stations in older classrooms
   c. It gives students a reason to pay attention beyond mere compliance
   d. It provides a fixed routine that signals the start of each lesson

   *Answer: c. It gives students a reason to pay attention beyond mere compliance*
...
**6. What does the unit identify as the most reliably disruptive point in any lesson?**
   ...
   b. The final clean-up phase at the end of station time
   c. The period when students are choosing their learning stations
   d. The moment between one activity and the next

   *Answer: d. The moment between one activity and the next*
...
**7. According to the unit, what is the primary cost of concentrating authority in the controller role during a teacher-centered lesson?**
   ...
   a. Students lose free production and decision-making opportunities.
   b. Students become confused about lesson objectives without teacher direction.
   ...
   *Answer: a. Students lose free production and decision-making opportunities.*
...
**8. The unit describes tools such as the Discussion Leader Self-Assessment Worksheet and the Peer Assessment Worksheet. In which teacher role does distributing these tools place the teacher?**
   ...
   d. Monitor, because the worksheets allow the teacher to observe student performance unobtrusively.

   *Answer: b. Resource, because the tools provide structured support so students can operate with genuine independence.*
...
**9. The unit describes a student named Priya, who consistently waits to hear a classmate's answer before producing her own during a game of Hot Potato. What does the unit say a monitoring teacher should do with this observation?**
   ...
   b. Switch to a written assessment so Priya cannot rely on classmates for answers.
   c. Record it unobtrusively for later reteaching or regrouping.
   d. Assign Priya the role of discussion leader in the next activity to build her confidence.

   *Answer: c. Record it unobtrusively for later reteaching or regrouping.*
...
**10. According to the unit, what makes a partial or confused student response to a repetition-back request MORE useful than silence?**
   ...
   b. It reduces the cognitive load on learners who are processing a new language.
   c. It confirms that at least one student has processed the instruction correctly.
   d. It shows where the breakdown occurred so the teacher can restate only the missing part.

   *Answer: d. It shows where the breakdown occurred so the teacher can restate only the missing part.*
...
**11. The unit argues that off-task behaviors such as students standing during a seated activity or talking out of turn should be treated as symptoms rather than isolated incidents. What does this shift in perspective direct the teacher's attention toward?**
   ...
   *Answer: a. The instructions themselves, because clear language reduces mid-task corrections.*
...
**12. The unit explains that demonstration is especially important with very young learners during movement activities. What specific problem does a lengthy verbal explanation create for this age group at that moment?**
   ...
   b. It requires stillness and language processing when learners should move
   ...
   *Answer: b. It requires stillness and language processing when learners should move*
...
**13. According to the unit, what is the primary purpose of asking teachers to draw their 'ideal classroom' during the warm-up activity?**
   ...
   c. To expose previously invisible assumptions about learning
   d. To compare resource levels across different national school systems

   *Answer: c. To expose previously invisible assumptions about learning*
...
**14. The unit argues that treating classroom decisions such as how to arrange chairs or give feedback as culturally neutral is itself what?**
   ...
   c. A necessary starting point before observation begins
   d. A cultural assumption worth examining

   *Answer: d. A cultural assumption worth examining*
...
**15. How does the unit distinguish between a reflective log entry and a guess when it comes to cultural adaptation?**
   ...
   *Answer: a. A log entry records specific observed moments and becomes the basis for genuine adaptation*
...
**16. According to the unit, what is the central principle behind grading the task rather than the text?**

   a. The teacher rewrites the authentic document to match each proficiency level
   b. The teacher adjusts what students do with a text, not the text itself
   c. The teacher selects a different authentic text for each student in the room
   d. The teacher removes idiomatic phrasing so all students can access the material

   *Answer: b. The teacher adjusts what students do with a text, not the text itself*
   *Anchor: "unit 7.4 quiz"*

**17. The unit describes four techniques a teacher can use to adapt a coursebook activity. Name all four.**

   *Answer: Adding, removing, modifying, and replacing.*
   *Anchor: "unit 10.4 quiz"*
