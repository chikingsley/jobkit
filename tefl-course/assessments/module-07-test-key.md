# Module 7 Test — Receptive Skills

Covers units 7.1 to 7.4. 19 points total; pass mark 70%. Section B re-asks questions from earlier modules: retrieving material again after a delay is part of how this course makes it stick.

## Section A — This module (12 points, 1 each)

**1. According to the unit, what is the purpose of pre-teaching vocabulary items such as 'take a statement' and 'come out of nowhere' before the audio plays?**

   a. To test whether students can guess the meaning of idioms from context
   b. To remove obstacles that have nothing to do with listening ability so students can recognize phrases rather than stop to decode them
   c. To make the listening task easy by removing all challenge from the audio
   d. To introduce the grammar structures students will need for the post-listening writing task

   *Answer: b. To remove obstacles that have nothing to do with listening ability so students can recognize phrases rather than stop to decode them*
...
**3. The unit warns that extending the warm-up discussion or replaying the audio an extra time can have a specific negative consequence. What is that consequence?**
   ...
   c. Students become over-prepared and find the detail-listening task too easy
   d. The post-listening task is prevented from being reached, leaving the listening work unfinished

   *Answer: d. The post-listening task is prevented from being reached, leaving the listening work unfinished*
...
**4. According to the unit, what distinguishes a receptive skill from a productive skill?**
   ...
   a. A receptive skill requires learners to generate language, while a productive skill involves taking in meaning.
   b. A receptive skill involves taking in and processing language rather than producing it.
   c. A receptive skill is always passive, while a productive skill demands active engagement.
   d. A receptive skill is limited to reading, while a productive skill covers speaking and writing only.

   *Answer: b. A receptive skill involves taking in and processing language rather than producing it.*
   *Anchor: "A receptive skill is one through which a learner receives and processes language rather than producing it."*
...
**6. What principle does the unit identify as governing the choice of texts for a reading lesson?**
   ...
   b. Texts should be chosen to match a single narrow proficiency band in the class.
   c. Texts should be chosen primarily for their grammatical complexity and range.
...
**7. How many studies did Jeon and Day (2016) synthesize in their meta-analysis, and why does this number matter?**
   ...
   b. 49 studies, because more studies always produce larger effect sizes
   c. 49 studies, because a broader sample reduces the chance that results reflect an unusual cluster from a narrow range of contexts
   d. 34 studies, because matching Nakanishi's sample size allows direct comparison

   *Answer: c. 49 studies, because a broader sample reduces the chance that results reflect an unusual cluster from a narrow range of contexts*
...
**8. What is the primary reason the unit recommends starting with a single reading station rather than setting up several at once?**
   ...
   a. One well-resourced, well-organized corner that students understand and value is more effective than three stations that feel provisional
   b. Multiple stations require more books than most schools can afford
   ...
   *Answer: a. One well-resourced, well-organized corner that students understand and value is more effective than three stations that feel provisional*
...
**9. How does the unit distinguish extensive reading from intensive reading?**
   ...
   a. Extensive reading involves moving through whole books at a comfortable pace, while intensive reading involves a teacher guiding students slowly through a short, often difficult passage line by line
   b. Extensive reading uses graded readers while intensive reading uses authentic texts
   c. Extensive reading focuses on grammar and vocabulary while intensive reading focuses on enjoyment
   d. Extensive reading is done at home while intensive reading takes place in the classroom

   *Answer: a. Extensive reading involves moving through whole books at a comfortable pace, while intensive reading involves a teacher guiding students slowly through a short, often difficult passage line by line*
...
**10. According to the unit, why does rewriting an authentic text to lower its difficulty undermine its value?**
   ...
   b. It prevents teachers from using the material across multiple proficiency levels
   c. It increases the cultural load by introducing unfamiliar simplified vocabulary
   d. It removes the idiomatic phrasing that reflects real language use in culturally appropriate contexts

   *Answer: d. It removes the idiomatic phrasing that reflects real language use in culturally appropriate contexts*
...
**11. The unit describes the tourist album project about the Sinai Peninsula as an example of authentic materials supporting which specific outcome beyond the classroom?**
   ...
   b. Older students presented the album to a local tourism board
   c. The finished album was added to the school library, giving the project an audience beyond the classroom
   d. The album was published on the internet for other language learners

   *Answer: c. The finished album was added to the school library, giving the project an audience beyond the classroom*
...
**12. Which of the following best explains why a student who follows local football will tolerate more linguistic difficulty in a match report than in an article about an unfamiliar sport?**
   ...
   a. The student brings prior knowledge to the text and compensates for gaps in linguistic understanding
   b. Football vocabulary is simpler and contains fewer technical terms than other sports
   c. Match reports are always written at a lower reading level than other newspaper articles
   d. The teacher has pre-taught the key vocabulary before the student reads the report

   *Answer: a. The student brings prior knowledge to the text and compensates for gaps in linguistic understanding*
   *Anchor: "students bring prior knowledge to the text and compensate for gaps in linguistic understanding"*
