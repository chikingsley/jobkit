...
**5. According to the unit, what is the key problem with how the source glossary defines 'visual learner' and 'kinesthetic learner'?**
   ...
   *Answer: b. The definitions conflate preferring a format with benefiting from it by placing the two verbs side by side without comment*
...
**10. According to the unit, what distinguishes a critical thinking question from a comprehension check in terms of motivation?**
   ...
   *Answer: a. A comprehension check requires students to recall facts, while a critical thinking question invites students to predict, evaluate, or offer opinions, drawing on their own interpretive capacity.*
...
**13. What effect size did Nakanishi (2015) report when comparing an extensive reading group against a control group?**
...
**14. The unit describes 'proactive behavior' in discipline management as distinct from reactive behavior. Which of the following best captures the unit's definition of proactive behavior?**
...
**15. Mr. Osei is planning a reading lesson for his mixed-level adult class. After observing his students for two weeks, he has noticed that Daniel always draws diagrams in his notebook, Yuki frequently asks to work alone, and Carlos often struggles to retain new vocabulary. A colleague suggests that Mr. Osei should diagnose each learner's dominant learning style — visual for Daniel, solitary for Yuki — and then design separate instructional tracks matched to those styles, so that Daniel receives only diagram-based tasks and Yuki always works independently. Mr. Osei is unsure whether to follow this advice. What would you recommend he do instead, and why?**
   ...
   *Rubric (5 points): declines the style-matching approach (1); cites the evidence that diagnosing a fixed style and restricting instruction to it does not improve outcomes (2); preserves that learner differences are real and recommends building variety of formats into the lesson (2).*
