# Module 9 Test — Feedback & Error Correction

Covers units 9.1 to 9.3. 16 points total; pass mark 70%. Section B re-asks questions from earlier modules: retrieving material again after a delay is part of how this course makes it stick.
...
**6. According to the unit, what is the recommended feedback technique for an accuracy-focused writing task such as copying a text?**
   ...
   a. The teacher marks every deviation from the original and returns the work with corrections.
   b. A partner reads the finished copy aloud while the other student follows the original model.
   c. The student works through a self-correction checklist before submitting the work.
   d. The teacher provides guidelines in advance specifying which points will be evaluated.

   *Answer: b. A partner reads the finished copy aloud while the other student follows the original model.*
   *Anchor: "a partner reads the finished copy aloud while the other student follows the original model"*
...
**7. According to the unit, what is the teacher's FIRST obligation when encountering an incorrect form in a student's production?**
   ...
   a. A. Immediately provide the correct form so the student can move on
   b. B. Understand why the incorrect form occurred and determine whether it reflects missing knowledge or a careless slip
   c. C. Record the error and address it only if it recurs in a second piece of work
   d. D. Ask the whole class whether they can identify what went wrong

   *Answer: b. B. Understand why the incorrect form occurred and determine whether it reflects missing knowledge or a careless slip*
...
**8. The unit describes a student named Carlos who attempts a complex conditional sentence and gets it wrong, contrasting him with a student who avoids the structure entirely. What point does this contrast illustrate?**
   ...
   a. A. Avoiding difficult structures is a sign of strong metalinguistic awareness
   b. B. Attempting a structure and failing is less productive than staying within known language
   c. C. A failed attempt generates useful data about the learner's developing system, making it more productive than avoidance
   d. D. Teachers should discourage risk-taking until foundational structures are fully mastered

   *Answer: c. C. A failed attempt generates useful data about the learner's developing system, making it more productive than avoidance*
...
**9. When the unit discusses a pragmatic error, which of the following examples best fits its definition?**
   ...
   a. A. A student writes 'she go to school' instead of 'she goes to school'
   b. B. A student says 'I am very boring' when meaning to say 'I am very bored'
   c. C. A student addresses a new teacher with 'Hey, tell me the answer,' using a register suited to a peer
   d. D. A student omits the past-tense marker, saying 'yesterday I go to the market'

   *Answer: c. C. A student addresses a new teacher with 'Hey, tell me the answer,' using a register suited to a peer*
