...
**1. According to the unit, what is the first question a teacher should ask when sitting down to plan a lesson?**
   ...
   *Answer: What will students be able to do with the content by the time the lesson ends?*
...
**2. The unit argues that learners benefit from knowing the lesson aim in advance. Which of the following best explains why?**
   ...
   *Answer: It enables learners to monitor their own progress and recognize when they have succeeded.*
...
**3. The unit warns against an aim that is too narrow as well as one that is too broad. What specific problem does a too-narrow aim create?**
   ...
   *Answer: The remaining lesson time has no anchor and activities risk becoming disconnected from any clear purpose.*
...
**4. According to the unit, what is the PRIMARY purpose of the background information section of a lesson plan?**
   ...
   *Answer: To record contextual facts that shape every subsequent decision, from text complexity to time allocated for pair work*
...
**5. In the Eastern College lesson plan example, why is the topic of road safety described as relevant to the specific group of learners rather than an arbitrary choice?**
   ...
   *Answer: Because most learners hold or are seeking jobs in service industries or technical fields where road safety is directly encountered*
...
**6. What specific function does the Pre-class Preparation field serve that is DISTINCT from the procedure column of the lesson plan?**
   ...
   *Answer: It lists tasks the teacher must complete before students arrive, such as printing materials or setting up equipment*
...
**7. According to the unit, what distinguishes a 'flexible' plan from a 'loose' plan?**
   ...
   b. A flexible plan has clear objectives, a ranked sequence, and identified points where time can be compressed or expanded; a loose plan has no structure to return to.
   c. A flexible plan integrates all six language skills equally; a loose plan focuses on only one.
   d. A flexible plan is shared with colleagues before teaching; a loose plan is used without peer review.

   *Answer: A flexible plan has clear objectives, a ranked sequence of activities, and identified points where time can be compressed or expanded, whereas a loose plan has no structure to return to when something goes wrong.*
...
**8. Why does the unit say that writing 'do vocabulary' as a lesson aim is insufficient?**
   ...
   *Answer: The phrase tells the teacher nothing about which words, what level of knowledge is expected, or how students will demonstrate understanding, and it cannot guide sequencing or timing decisions.*
...
**9. What pedagogical reason does the unit give for including movement in the closing stage of a lesson?**
   ...
   *Answer: A physical transition signals a shift in cognitive mode and gives the teacher a final sweep of the room to gather informal evidence of learning.*
...
**10. According to the unit, what is the primary purpose of pre-reading two or three units ahead of the one currently being taught?**
   ...
   *Answer: To ensure that isolated lesson decisions become coherent course planning with awareness of downstream consequences.*
...
**11. When the unit describes the 'modifying' adaptation technique, what does it identify as the element that must remain unchanged even when the format of an activity is altered?**
   ...
   *Answer: The original lesson aim of the activity.*
...
**12. The unit gives three distinct reasons that can legitimately justify supplementing a coursebook. Which of the following is listed as one of those reasons?**
   ...
   *Answer: A unit topic coincides with a current local news story that students already care about.*
...
**13. According to the unit, what distinguishes the self- and peer-assessment checklist from a worksheet or graphic organizer in terms of its primary function?**
   ...
   *Answer: It asks the student to shift from writer to evaluator by applying lesson criteria consciously*
...
**14. The unit explains why full-sized paper puppets are particularly suited to whole-group storytelling. Which of the following best captures that reasoning?**
   ...
   b. Their scale draws attention and signals to students that a narrative frame has opened
   c. Students can color and cut them out, making construction itself a form of language work
   d. They are simple enough for students to make, so class time goes toward the language activity

   *Answer: Their scale draws attention and signals to students that a narrative frame has opened*
...
**15. The unit presents Fatima's gap-fill activity built around a popular local song as an example of what broader principle?**
   ...
   d. That teachers should only use materials requiring paper, scissors, and basic adhesives

   *Answer: That self-made materials are a normal feature of experienced teaching, not a fallback when published resources are unavailable*
...
**16. According to the unit, what specific language structures does drawing provide a context for practicing, based on the example dialogue between a teacher and Daniel?**
   ...
   *Answer: Present continuous forms and comparative adjectives*
...
**17. The unit describes two distinct modes of drawing activities. What distinguishes drawing from observation from drawing from imagination?**
   ...
   b. Drawing from observation is done individually while drawing from imagination is always a group task
   c. Drawing from observation requires students to look directly at a subject, while drawing from imagination draws on memory and invention
   d. Drawing from observation is recommended for older learners while drawing from imagination suits younger students

   *Answer: Drawing from observation requires students to look directly at a subject, while drawing from imagination draws on memory and invention*
...
**18. The unit describes stick puppets as particularly useful for very young learners. What specific benefit does the unit attribute to giving young learners a character to speak through?**
   ...
   *Answer: It can reduce the self-consciousness that sometimes accompanies early oral production*
...
**19. In the Sentence Boundaries game, what does the teacher do when a team submits a sentence that meets the word-count requirement but contains a grammatical error?**
   ...
   *Anchor: "unit 8.3 quiz"*

**20. Explain why a speaker cannot use the present perfect in the sentence 'I have seen that film in 2019,' and state the correct form.**
