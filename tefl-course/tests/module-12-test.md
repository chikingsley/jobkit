# Module 12 Test — Knowing Your Learners

Covers units 12.1 to 12.4. 19 points total; pass mark 70%. Section B re-asks questions from earlier modules: retrieving material again after a delay is part of how this course makes it stick.
...
**1. According to the unit, what is the PRIMARY purpose of posting clear instructions and schedules throughout learning stations and self-access areas?**
   ...
   *Answer: When a learner can read the steps for using the listening equipment independently, or consult a posted schedule to know which area she should move to next, she is managing her own learning time rather than waiting for the teacher to redirect her.*
...
**2. The unit describes an outdoor data-collection project in which younger children counted animals and insects in their neighborhoods. Which of the following best explains why the unit presents this as an effective motivational strategy?**
   ...
   *Answer: When learners can see that the language they are practicing belongs to real situations they have encountered, they are more willing to apply effort to it.*
...
**3. The unit identifies seven dimensions along which teachers can vary their practice. Which of the following is described as the THIRD dimension in that toolkit?**
   ...
   *Answer: The medium through which input reaches learners is a third variable. Textbooks, audio recordings, and internet resources each engage different perceptual channels and suit different learning preferences.*
...
**4. Why does the unit argue that learning-styles theory carries a 'moral weight' that makes it difficult for teachers to abandon?**
   ...
   *Answer: Sorting students into types feels like paying attention to them as individuals, and that instinct reflects something genuinely valuable about good teaching.*
...
**5. According to the unit, what is the key problem with how the source glossary defines 'visual learner' and 'kinesthetic learner'?**
   ...
   a. The definitions use outdated terminology that modern neuroscience has replaced
   b. The definitions conflate preferring a format with benefiting from it by placing the two verbs side by side without comment
   c. The definitions exclude important style categories such as logical and solitary learners
   d. The definitions are too technical for practicing teachers to apply in the classroom

   *Answer: Those two verbs are doing very different work, and placing them side by side without comment treats them as equivalent.*
   *Anchor: "Those two verbs are doing very different work, and placing them side by side without comment"*
...
**6. The unit describes Willingham, Hughes, and Dobolyi (2015) as going 'a step further' than simply confirming the lack of evidence for learning styles. What additional position did they take?**
   ...
   *Answer: They argued that learning-styles theories should be presented to teachers and trainee teachers as a popular but scientifically debunked idea.*
...
**7. According to Beckman, what is the recommended approach when introducing cognitive strategies to learners?**
   ...
   *Answer: Introduce strategies one at a time, then show students how to combine them for specific tasks.*
...
**8. Which step in Beckman's strategy instruction sequence is specifically aimed at moving a strategy toward automaticity?**
   ...
   *Answer: Repeated assisted practice during which the teacher monitors, provides cues, and gives feedback.*
...
**9. What does the unit identify as one concrete way the physical classroom environment can support ongoing strategy integration?**
   ...
   *Answer: Posting written reminders for learning strategies on walls and bulletin boards.*
...
**10. According to the unit, what distinguishes a critical thinking question from a comprehension check in terms of motivation?**
   ...
   a. A comprehension check requires students to recall facts, while a critical thinking question invites students to predict, evaluate, or offer opinions, drawing on their own interpretive capacity.
   b. A comprehension check is always given in written form, while a critical thinking question is always delivered orally.
   c. A critical thinking question is used only at the start of a lesson to activate prior knowledge, while a comprehension check is used only at the end.
   d. A comprehension check encourages personal storytelling, while a critical thinking question focuses on factual accuracy.

   *Answer: Critical thinking questions ask students to think on a higher and deeper level, inviting them to predict, evaluate, or offer opinions, whereas comprehension checks focus on factual recall.*
   *Anchor: "critical thinking questions 'ask the students to think on a higher and deeper level' and often invite students to predict, evaluate, or offer opinions"*
...
**11. The unit argues that a task pitched at the wrong level of difficulty undermines motivation. What specific outcome does the unit say results when the gap between a student's current ability and the task's demands is too wide?**
   ...
   *Answer: If the gap between what a student can currently do and what the task demands is too wide, effort gives way to withdrawal.*
...
**12. The unit describes a teacher circulating during group activities rather than waiting at the front of the room. What motivational function does this practice primarily serve, according to the unit?**
   ...
   *Answer: The teacher circulating is present while work is happening, available to redirect, confirm, or prompt, and makes small successes visible to learners while they are still fresh.*
...
**13. What does substituting 'when' for 'if' in a first conditional sentence signal to the listener?**

   *Answer: The condition is certain to occur*
   *Anchor: "unit 3.2 quiz"*

**14. What practical function does the paper tracking grid serve in a spacing schedule, according to the unit's planning section?**
...
**15. Mr. Osei is planning a reading lesson for his mixed-level adult class. After observing his students for two weeks, he has noticed that Daniel always draws diagrams in his notebook, Yuki frequently asks to work alone, and Carlos often struggles to retain new vocabulary. A colleague suggests that Mr. Osei should diagnose each learner's dominant learning style — visual for Daniel, solitary for Yuki — and then design separate instructional tracks matched to those styles, so that Daniel receives only diagram-based tasks and Yuki always works independently. Mr. Osei is unsure whether to follow this advice. What would you recommend he do instead, and why?**
   ...
   *Answer: Mr. Osei should not adopt the colleague's matching approach. Although Daniel's diagram-drawing and Yuki's preference for solitary work are real and worth noticing, the research reviewed in the module shows that diagnosing a fixed style and then restricting instruction to fit that diagnosis does not produce the predicted learning benefit — this is the meshing hypothesis, and Pashler, McDaniel, Rohrer, and Bjork (2009) found no adequate evidence to support it. Willingham, Hughes, and Dobolyi (2015) went further, arguing that learning-styles theories should be treated as a popular but scientifically debunked idea rather than a basis for planning decisions. Acting on the colleague's advice would therefore mean building the lesson around a framework the evidence does not support.

What Mr. Osei should do instead is apply differentiated instruction — varying his teaching in order to create the best learning experience possible for individuals or small groups — without locking any learner into a single mode. For Carlos's vocabulary retention difficulties, Mr. Osei can explicitly teach cognitive strategies such as visualization, making associations, chunking, and using mnemonics, since successful learners draw on several of these at once depending on the task. He can also build in a metacognitive moment — pausing to ask students how they are approaching a task — so that learners like Yuki develop awareness of their own mental processes and can self-regulate over time. For motivation, Mr. Osei can offer a range of follow-up mini-tasks (e.g., drawing a concept map, writing a summary, discussing with a partner) so that students like Daniel can select a mode that suits their strengths without being permanently confined to it. This approach honours the real individual differences the module maps — proficiency level, personality, motivation, preferred strategies — while remaining grounded in what the research actually supports.*
