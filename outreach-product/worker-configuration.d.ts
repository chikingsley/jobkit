/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 12a374dd6917b36dfdbfd641a8f2f20c)
// Runtime types generated with workerd@1.20260714.1 2026-07-11 nodejs_compat
interface __BaseEnv_Env {
	DOCUMENTS: R2Bucket;
	SWEEP_OUTPUTS: R2Bucket;
	DB: D1Database;
	PUBLIC_PROJECTION_QUEUE: Queue;
	AGENT_MAINTENANCE_QUEUE: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "MISTRAL_API_KEY" | "BETTER_AUTH_SECRET" | "JOBKIT_RUNNER_TOKEN">> {}
}
