...
export const JOB_MATCH_FACTS_PROMPT_VERSION = "job-match-facts-v1";
export const JOB_POSITION_TASK_TYPE = "job.position_analysis";
export const JOB_POSITION_PROMPT_VERSION = "job-position-analysis-v1";

export const JOB_MATCH_FACTS_OUTPUT_JSON_SCHEMA = z.toJSONSchema(
  JobMatchFactsSchema,
  { target: "draft-2020-12" }
);
export const JOB_POSITION_OUTPUT_JSON_SCHEMA = z.toJSONSchema(
