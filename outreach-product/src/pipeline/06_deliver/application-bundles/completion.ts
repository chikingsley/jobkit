...
import { defaultPacketSnapshotWrites } from "../../../../worker/repositories/draft-attachments";
import { jobEventStatement } from "../../../../worker/repositories/job-events";
import { readActiveAgentTaskRequest } from "../../../../worker/services/agent-task-requests";
import type {
  AgentTaskCompletionFence,
  AgentTaskCompletionWrite,
} from "../../../../worker/services/agent-tasks/run-store";
import { APPLICATION_MESSAGE_TASK_TYPE } from "../../../agent-tasks/application-message";
import {
  DraftMutationError,
  savedProfile,
