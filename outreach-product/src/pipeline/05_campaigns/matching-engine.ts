...
import { readQualificationClaims } from "../../../worker/repositories/qualification-claims";
import {
  readPreferences,
  readProfile,
} from "../../../worker/repositories/user-settings";
import { fetchExchangeRates } from "../../../worker/services/lookups";
import { monthlyCompensationUsd } from "../../features/jobs/compensation";
import type { FxData, Job } from "../../features/jobs/types";
import type { QualificationClaims } from "../../pipeline/03_match/claims";
import { evaluateJob } from "../../pipeline/03_match/evaluate";
