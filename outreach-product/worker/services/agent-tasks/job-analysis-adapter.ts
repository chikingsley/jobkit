...
import {
  completeJobContentTask as completeJobContentTaskImpl,
  completeJobMatchFactsTask as completeJobMatchFactsTaskImpl,
  completeJobPositionTask as completeJobPositionTaskImpl,
} from "./job-analysis-completion";
import { createAgentTaskRun, isConstraintError } from "./run-store";

export function completeJobPositionTask(
  env: AppEnv,
  ...
  return completeJobPositionTaskImpl(env, runner, run, runId, rawOutput);
}

export function completeJobMatchFactsTask(
  env: AppEnv,
  runner: AgentRunnerContext,
  run: AgentTaskRunRow,
  runId: string,
  ...
  return completeJobMatchFactsTaskImpl(env, runner, run, runId, rawOutput);
}

export function completeJobContentTask(
  env: AppEnv,
  runner: AgentRunnerContext,
  run: AgentTaskRunRow,
  runId: string,
